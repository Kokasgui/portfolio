...
document.querySelectorAll("input").forEach((input) => {
    ...
    input.addEventListener("change", () => {
        ...
        if (input.getAttribute("type") === "checkbox") {
            // Caso a checkbox esteja no menu de opções
            if (document.querySelector("#options").contains(input)) {
...
if (main.querySelector("#gallery-buttons")) {
    // main.querySelector("#gallery-buttons").addEventListener("mousedown", (e) => {
    //     e.preventDefault();
    // });
...
function PlayAnimation(element) {
    ...
    if (element.tagName === "FIGURE") {
        ...
        if (element.tagName === "VIDEO" && element.ended) {
    ...
    if (main.contains(focusedElement) || footer.contains(focusedElement) || mainNav.contains(focusedElement) || options.contains(focusedElement)) {
        ...
        while (currentNode) {
            ...
            if (
                ...
                (focusedElement.tagName === "LABEL" || focusedElement.tagName === "INPUT")
            ) {
                // debugger;
